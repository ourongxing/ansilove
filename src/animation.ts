...
import type { AnimationController, Ansimation as AnsimationType, RenderOptions, Sauce } from "./types"
...
export function Ansimation(bytes: Uint8Array, options: RenderOptions): AnsimationType {
  ...
  const blinkCtx = blinkCanvas.map((canvas: HTMLCanvasElement): CanvasRenderingContext2D => {
