...
export function httpGet(url: string, callback: (data: Uint8Array) => void, callbackFail?: (status: number) => void): void {
...
export function sauce(url: string, callback: (sauce?: Sauce) => void, callbackFail?: (status: number) => void): void {
